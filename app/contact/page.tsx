...
export default function ContactPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const mailtoLink = `mailto:ganukalp70@gmail.com?subject=[${formData.category}] ${formData.subject}&body=From: ${formData.name} (${formData.email})%0D%0A%0D%0A${formData.message}`
